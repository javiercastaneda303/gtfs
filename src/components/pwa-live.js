...
export class PwaLive extends LitElement {
  ...
  -->
    <div class="center">
	  ${this.page=="presentacion"
		  ? html`<button class="activo botonMenu" @click= ${this.go} name="presentacion"> Presentación</button>`
		  : html`<button class="pasivo botonMenu" @click= ${this.go} name="presentacion"> Presentación</button>`
	  }
	  ${this.page=="servicios"
		  ? html`<button class="activo botonMenu" @click= ${this.go} name="servicios">Servicios</button>`
		  : html`<button class="pasivo botonMenu" @click= ${this.go} name="servicios">Servicios</button>`
	  }
	  ${this.page=="contacto"
    ...
    <dile-pages selected="${this.page}" attrForSelected="name">
		...
		<view-about name="servicios" ?active=${this.page == 'servicios'}></view-about>
	  ...
	  <view-servicios name="servicios" ?active=${this.page=="servicios"}></view-servicios>
	  ...
	  ${this.page=='servicios'
		  ? html`<view-servicios name="servicios" ?active=${this.page=="servicios"}></view-servicios>`
		  : ''
	  }
	  ${this.page=='contacto'
